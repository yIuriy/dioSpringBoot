...
public class AMQPConfig {
    ...
    @Bean
    DirectExchange exchange(@Value("${spring.rabbitmq.routing-key.product-change-availability}") final String name) {
    ...
    Binding binding(
            ...
            @Value("${spring.rabbitmq.queue.product-change.availability}") final String name
    ) {
